    ...
    <nav className={`sticky top-0 z-50 w-full transition-all duration-300 ${isScrolled
      ...
      <div className="container mx-auto flex h-16 items-center justify-between px-4 md:px-6">
        ...
        <div className="flex items-center gap-2">
          <Sparkles className={`h-6 w-6 transition-colors ${isScrolled ? 'text-blue-600 dark:text-blue-400' : 'text-blue-500'}`} />
          <Link to="/" className={`text-xl font-bold transition-colors ${isScrolled ? 'text-blue-900 dark:text-white' : 'text-white'}`}>
            StrollUP
          </Link>
        </div>
        ...
        <div className="hidden items-center gap-8 md:flex">
          <a href="#features" className={`text-sm font-medium transition-colors ${isScrolled ? 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400' : 'text-gray-300 hover:text-blue-400'
            }`}>
            Features
          </a>
          <a href="#pricing" className={`text-sm font-medium transition-colors ${isScrolled ? 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400' : 'text-gray-300 hover:text-blue-400'
            }`}>
            Pricing
          </a>
          <a href="#about" className={`text-sm font-medium transition-colors ${isScrolled ? 'text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400' : 'text-gray-300 hover:text-blue-400'
            }`}>
            About
          </a>
        </div>
        ...
        <div className="flex items-center gap-4 md:gap-6 mr-8">
          <div className={`hidden md:flex items-center gap-8 text-base font-medium transition-colors ${isScrolled ? 'text-gray-700 dark:text-gray-300' : 'text-gray-200'}`}>
